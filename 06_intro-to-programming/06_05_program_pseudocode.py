...
# Task: save all of words in a word document into a single variable or data structure

# make a variable (array) called words to store all of the words from the word document
# for each word in the word document
#     add it to the last space in the array 
