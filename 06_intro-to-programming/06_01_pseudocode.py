...
# save all the names of the kittens into an array representing their names
# for each name in the array
#     confirm each of the kittens are cute
#     display a message that the kitten is ready for adoption